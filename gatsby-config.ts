  ...
  plugins: [
    {
      ...
      options: {
        ...
        externalLinks: [
          ...
          {
            name: `Homepage`,
            url: `https://notion.shepherdtoherd.me/`,
          },
        ],
      },
    },
    ...
    },
    {
      ...
      options: {
        name: `Shepherd's Blog - 时间洪流`, // 修改为您的博客全名
        short_name: `Shepherd's Blog`, // 修改为您的博客简称
        description: `在时间的洪流中，寻找属于自己的声音`, // 修改为您的博客描述
        start_url: `/`,
  ...
  allPost(sort: {date: DESC}) {
    nodes {
      ...
      slug
            ...
            output: `rss.xml`,
            title: `Shepherd's Blog`, // 修改为您的博客标题
          },
        ],
      },
    },
